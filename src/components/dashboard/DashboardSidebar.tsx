  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed lg:static top-0 left-0 z-50 h-full w-72 shrink-0 ${getRoleThemeBg()} border-r-4 border-[#181818] brutal-shadow flex flex-col justify-between p-4 sm:p-5 transition-all duration-200 ease-in-out select-none overflow-y-auto overscroll-contain ${
